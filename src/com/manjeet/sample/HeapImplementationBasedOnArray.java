...
public class HeapImplementationBasedOnArray<AnyType extends Comparable<AnyType>>
{
   ...
   public HeapImplementationBasedOnArray()
   {
      size = 0;
  ...
  */
   public HeapImplementationBasedOnArray(AnyType[] array)
   {
      size = array.length;
  ...
  */
   ...
   {
      HeapImplementationBasedOnArray<String> h = new HeapImplementationBasedOnArray<String>();
      ...
      HeapImplementationBasedOnArray<Integer> tmp = new HeapImplementationBasedOnArray<Integer>();
