...
{       
    ...
    //Constructor   
    public MysqlConnectionPool(String url, String user, String passwd) throws SQLException   
    {   
    ...
    {   
       ...
       public static void main (String[] args)   
        {       
            ...
            try   
            {           
                MysqlConnectionPool cp = new MysqlConnectionPool("jdbc:mysql://localhost:3306/test","root","");   
                ...
                String selectEmployeesSQL = "SELECT * FROM t2";
                ResultSet resultSet = statement.executeQuery(selectEmployeesSQL);

                while (resultSet.next()) {
                    System.out.print(resultSet.getString("uuid")+", ");
